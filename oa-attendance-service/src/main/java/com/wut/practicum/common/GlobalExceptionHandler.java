...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResult<Object>> handleBusiness(BusinessException exception) {
        return ResponseEntity.status(exception.getStatus()).body(new ApiResult<>(exception.getCode(), exception.getMessage(), exception.getData(), org.slf4j.MDC.get("traceId")));
    }
